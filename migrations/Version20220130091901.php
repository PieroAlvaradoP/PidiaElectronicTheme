 ...
 */
final class Version20220130091901 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipo_marca ADD CONSTRAINT FK_F976C8D724DB0683 FOREIGN KEY (config_id) REFERENCES config (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE equipo_marca ADD CONSTRAINT FK_F976C8D753C8D32C FOREIGN KEY (propietario_id) REFERENCES usuario (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
